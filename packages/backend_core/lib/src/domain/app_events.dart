...
abstract final class AppEvents {
  // ── Auth ──────────────────────────────────────────────
  static AnalyticsEvent authSignInSuccess(String authType) =>
      AnalyticsEvent(
  ...
  // ── Credit / Payment ──────────────────────────────────
  static const creditPurchaseIntent =
      AnalyticsEvent(name: 'credit_purchase_intent');
  ...
  static const creditInsufficient =
      AnalyticsEvent(name: 'credit_insufficient');
  ...
  static AnalyticsEvent onboardingStepViewed(int step) =>
      AnalyticsEvent(
  ...
  static const parcelQueryFailed =
      AnalyticsEvent(name: 'parcel_query_failed');

  // ── PDF / Report ──────────────────────────────────────
  static AnalyticsEvent reportGenerated(String queryId) =>
      AnalyticsEvent(
        name: 'report_generated',
        properties: {'query_id': queryId},
      );

  static AnalyticsEvent reportShared(String queryId) =>
      AnalyticsEvent(
        name: 'report_shared',
        properties: {'query_id': queryId},
      );
  ...
  // ── Navigation ────────────────────────────────────────
  static AnalyticsEvent deepLinkOpened(String path) =>
      AnalyticsEvent(
